...
export class  $name1760178517359 implements MigrationInterface {
    name = ' $name1760178517359'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_verificationstatus_enum" AS ENUM('pending', 'submitted', 'interview', 'interviewed', 'interview_fixed', 'verified', 'rejected')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_verificationstatus_enum_old" AS ENUM('pending', 'submitted', 'interview', 'interviewed', 'verified', 'rejected')`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "verificationStatus" DROP DEFAULT`);
